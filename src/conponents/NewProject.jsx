...
export default function NewProject({onAdd,onCancle}){
    ...
    return<>
     <Modal ref={modal} buttonText="Ok">
            <h2 className="text-xl font-bold text-stone-700 my-4">There is some Error</h2>
            <p className="text-stone-600 mb-4">Please check weather any data is missed out</p>
    </Modal>
